...
if __name__ == '__main__':
    ...
    parser.add_argument('--result-file', type=str, default='./comp.jsonl')
    parser.add_argument('--task-name', type=str, default='hellaswag')
    parser.add_argument('--model-type', type=str, default='test')
    ...
    elif args.model_type == 'test' or args.model_type == 'no_change':
        os.environ['MODEL_NAME'] = "facebook/opt-66b"
    else:
        assert False
